...
module.exports = {
    ...
    async execute({ sock, msg, from, reply, args }) {
        ...
        try {
            ...
            // Primary: render the dark "profile sheet" HTML card as a
            // botForwardedMessage rich response — the same mechanism .slot
            // and .cursedash already use successfully in this codebase.
            // Fallback: the plain nativeFlow button card, in case the
            // recipient's WhatsApp client is too old to render the rich
            // HTML message (mirrors the .cursedash fallback pattern).
            try {
