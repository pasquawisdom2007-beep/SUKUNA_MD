        ...
        return new Promise((resolve, reject) => {
            ...
            const onUpdate = update => {
                ...
                if (connection === 'connecting' && !attempted) {
                    // The fork documents requestPairingCode at the connecting
                    // lifecycle point. No fixed sleep or fallback timer is
                    // needed, so the code belongs to this socket reliably.
                    attempt().catch(fail);
